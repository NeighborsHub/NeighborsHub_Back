...
from users.views import PreRegisterAPI, VerifyPreRegisterAPI, RegisterAPI, VerifyEmailAPI, LoginApi, \
    ...
    GoogleLoginAPI, RetrieveUpdateUserAPI, UserDetailAPI, GoogleSetpasswordAPI, UpdateUserNameAPI
...
urlpatterns = [
    ...
    path('auth/set-password/google', GoogleSetpasswordAPI.as_view(), name='user_setpassword_google'),
    ...
    path('me/update-username', UpdateUserNameAPI.as_view(), name='update_username'),
